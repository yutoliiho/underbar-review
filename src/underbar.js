(function() {
  ...
  _.reject = function(collection, test) {
    ...
    var res = [];
    _.filter(collection, function(el) {
      if(!test(el)) {
        res.push(el);
      }
    });
  ...
  _.uniq = function(array, isSorted, iterator) {
    //if isSorted and iterator
    //result variable equal to empty array
    var res = [];
    // if sorted && no iterator
    if (isSorted && iterator) {
      _.each(array, function(el) {
        res.push(iterator(el));
      });
